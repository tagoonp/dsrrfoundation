    ...
    <div class="container dsd" style="background: #fff;">
      <div class="row">
        <div class="col-sm-10" style="padding-top: 20px;">
          <a href="./" class="link-b">DSRR</a> / <a href="#" class="link-b">กิจกรรม</a>
        </div>
      </div>
        ...
        <div class="col-sm-9">
          ...
          <div class="panel-content" style="padding-bottom: 30px;">
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
              ...
              <tbody>
                <?php
                $strSQL = sprintf("SELECT * FROM tsd_content WHERE ctg_id = '%s' and cont_status = 'Yes' ORDER BY cont_id desc", mysql_real_escape_string('2'));
                $resultActivities = $db->select($strSQL,false,true);
                if($resultActivities){
                  $c = 1;
                  foreach ($resultActivities as $value) {
                    ?>
                    <tr>
