                    ...
                    <!-- Page Content -->
                      <div class="container-fluid p-y-md">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <p>
                              <a href="media.php" class="btn btn-app-teal"><i class="fa fa-plus"></i> Add media</a>
                            </p>
                          </div>
                        </div>
                          ...
                          <div class="col-md-12">
                            <div class="card">
                              ...
                              <div class="card-block card-block-full" >
                                <?php
                                $strSQL = sprintf("SELECT * FROM tsd_media WHERE 1 ORDER BY media_id DESC LIMIT 0,40");
                                ...
                                if($resultMedia){
                                  ...
                                  foreach ($resultMedia as $value) {
                                    ...
                                    if(getFiletype($value['media_filename'])=='application/pdf'){
                                      ?>
                                      <div class="col-xs-3" style="margin: 10px 0px;">
                                        <a href="<?php print $value['media_url'];?>" target="_blank">
                                          <div class="card-block text-center bg-img" style="height: 170px; cursor: pointer;">
                                            <i class="fa fa fa-file-text-o fa-4x"></i>
                                              <p style="font-size:0.7em; margin-top: 10px;">
                                                <?php print $value['media_filename']; ?>
                                              </p>
                                      ...
                                      ?>
                                      <div class="col-xs-3" style="margin: 10px 0px;">
                                        <a href="Javascript: showImageMedal('<?php print $value['media_id'];?>')"><div class="card-block text-center bg-img" style="background-image: url('<?php print $value['media_url'];?>'); height: 170px; cursor: pointer;"></div></a>
                                      </div>
                                      <?php
                                    }
