                ...
                <main class="app-layout-content" style="background: #f3f3f3;">
                    ...
                    <div class="container-fluid p-y-md">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <p>
                            <a href="page.php" class="btn btn-app-teal"><i class="ion-android-list"></i>&nbsp;&nbsp;Page</a>
                          </p>
                        </div>
                      </div>
                      <form class="js-validation-bootstrap_post form-horizontal" action="controller/insert_page.php" method="post" >
                        <div class="row">
                          <div class="col-md-9">
                            <div class="card">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12">
                                      <select class="form-control" name="txtCategory" id="txtCategory">
                                        ...
                                        <option value="99">Single page</option>
                                      </select>
