                                        ...
                                        <form class="js-validation-bootstrap form-horizontal" action="controller/update-password.php" method="post" >
                                          <div class="row">
                                            ...
                                            <div class="form-group">
                                                <label class="col-xs-12" for="old-password">Old password <span class="text-red">**</span></label>
                                                <div class="col-xs-12">
                                                    <input class="form-control" type="password" id="old-password" name="old-password" placeholder="Enter password..." />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-xs-12" for="register1-password">New password <span class="text-red">**</span></label>
                                                <div class="col-xs-12">
                                                    <input class="form-control" type="password" id="new-password1" name="new-password1" placeholder="Enter password..." />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-xs-12" for="register1-password2">Confirm new password <span class="text-red">**</span></label>
                                                <div class="col-xs-12">
                                                    <input class="form-control" type="password" id="new-password2" name="new-password2" placeholder="Confirm password..." />
                                                </div>
                                            </div>
                                            <div class="form-group m-b-0">
                                                <div class="col-xs-12">
                                                    <button class="btn btn-app" type="submit">Update password</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
