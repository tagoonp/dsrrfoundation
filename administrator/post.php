                    ...
                    <!-- Page Content -->
                      <div class="container-fluid p-y-md">
                        <div class="row">
                          <div class="col-md-12">
                            <p>
                              <a href="add_post.php" class="btn btn-app-teal"><i class="fa fa-plus"></i> Add new</a>
                                      ...
                                      if($resultPost){
                                        ...
                                        foreach ($resultPost as $value) {
                                          ...
                                          <tr>
                                              ...
                                              <td>
                                                <a href="update_post.php?id=<?php print $value['cont_id'];?>"><?php print $value['cont_title'];?></a>
                                              </td>
