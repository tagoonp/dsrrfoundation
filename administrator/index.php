                      ...
                      <div class="container-fluid">
                          <div class="navbar-header">
                              ...
                              <span class="navbar-page-title">
                                Education staff panal :: Dashboard
                              </span>
                          </div>
                          ...
                          <div class="col-md-12">
                            <div class="card">
                              <div class="card-header bg-blue bg-inverse">
                                <h4>Number of student enrolled</h4>
                              </div>
                          ...
                          <div class="col-md-12">
                            <div class="card">
                              <div class="card-header bg-orange bg-inverse">
                                <h4>Number of Thai-Inter student enrolled</h4>
                              </div>
                              <div class="card-block">
                                <p>Card's content..</p>
                              </div>
                          ...
                          <div class="col-md-12">
                            <div class="card">
                              <div class="card-header bg-cyan bg-inverse">
                                <h4>Publications and citations per year</h4>
                              </div>
                              <div class="card-block">
                                <p>Card's content..</p>
                              </div>
                          ...
                          <div class="col-md-12">
                            <div class="card">
                              <div class="card-header bg-red bg-inverse">
                                <h4>Number of pulications and citation per year</h4>
                              </div>
                              <div class="card-block">
                                <p>Card's content..</p>
                              </div>
